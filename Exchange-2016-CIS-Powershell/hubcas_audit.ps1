...
Get-SenderReputationConfig | fl -property SenderBlockingEnabled >> $filename
...
echo "Get-MobileDeviceMailboxPolicy" >> $filename
echo "Get-MobileDeviceMailboxPolicy"
Get-MobileDeviceMailboxPolicy | fl -property Identity,AllowSimpleDevicePassword,DevicePasswordHistory,MinDevicePasswordLength,DevicePolicyRefreshInterval,AllowNonProvisionableDevices,RequireDeviceEncryption,MaxInactivityTimeDeviceLock,AlphanumericDevicePasswordRequired,MaxDevicePasswordFailedAttempts,DevicePasswordEnabled >> $filename
